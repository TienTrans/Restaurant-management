...
import { useListTables } from "@/queries/useTable"
...
export default function OrderTable() {
    ...
    const tableListQuery = useListTables()
    ...
    useEffect(() => {
        ...
        function onOrderUpdate(data: UpdateOrderResType["data"]) {
            ...
            toast({
                description: `Món ${name} (SL: ${quantity}) vừa được cập nhật sang trạng thái vừa được cập nhật ${getVietnameseOrderStatus(
                    data.status
                )}`,
            })
            refetch()
