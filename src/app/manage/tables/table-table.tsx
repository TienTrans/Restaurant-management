...
import { useDeleteTableMutation, useListTables } from "@/queries/useTable"
...
export const columns: ColumnDef<TableItem>[] = [
    {
        ...
        filterFn: (rows, columnId, fillterValue) => {
            if (!fillterValue) return true
            return String(fillterValue) === String(rows.getValue("number"))
        },
    },
    {
...
export default function TableTable() {
    ...
    const useTableList = useListTables()
    const data = useTableList.data?.payload.data ?? []
